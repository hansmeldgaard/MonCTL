...
MonCTL watches your infrastructure: network devices, servers, containers, and anything else that speaks SNMP, SSH, ICMP, HTTP or whatever you make apps and connectors for. A central HA cluster owns configuration and storage; distributed collectors do the work and ship results back. You get a React UI, a REST API, alerting, events, dashboards, RBAC, multi-tenancy, and a pack system for sharing monitoring logic.
