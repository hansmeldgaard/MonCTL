...
async def list_connectors(
    ...
    auth: dict = Depends(require_permission("connector", "view")),
...
async def create_connector(
    ...
    db: AsyncSession = Depends(get_db),
    auth: dict = Depends(require_permission("connector", "create")),
):
...
async def delete_connector(
    connector_id: str,
    db: AsyncSession = Depends(get_db),
    auth: dict = Depends(require_permission("connector", "delete")),
):
