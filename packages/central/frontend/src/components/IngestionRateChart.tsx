...
// Matches the table set the scheduler samples — kept in sync with
// SchedulerRunner._INGESTION_TABLES in packages/central scheduler/tasks.py.
const TABLES = [
 ...
 * samples produced by the scheduler's ingestion-rate sampler (see
 * SchedulerRunner._sample_ingestion_rates).
 */
